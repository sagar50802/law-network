// server/models/ResearchProposal.js
...
const StepStateSchema = new mongoose.Schema(
  {
    id: {
      type: String,
      enum: ["topic", "literature", "method", "timeline", "payment", "done"],
      required: true,
    },
    status: {
      type: String,
      enum: ["locked", "in_progress", "completed", "needs_edit"],
      default: "locked",
    },
...
export default mongoose.models.ResearchProposal ||
  mongoose.model("ResearchProposal", ResearchProposalSchema);
