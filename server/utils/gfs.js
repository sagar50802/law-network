...
/** Create a GridFS upload middleware for a specific bucket (e.g. "banners"). */
...
/** Pull 24-char ObjectId from /api/files/<bucket>/<id> URLs. */
...
/** Delete a file by id from a bucket. */
...
/** Stream file: GET /api/files/:bucket/:id */
export async function streamFile(req, res) {
  try {
    ...
    res.set("Content-Type", fileDoc.contentType || fileDoc.metadata?.mime || "application/octet-stream");
